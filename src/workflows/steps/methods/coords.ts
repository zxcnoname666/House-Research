...
export async function getCoordsByParsedAddress(address: string): Promise<{name: string, lat: number, lon: number}[]> {
...
if (import.meta.main) {
    const address = await parseAddress("Краснодарский край, Краснодар, Карасунский, мкр. Черемушки, Ставропольская ул., 113");
